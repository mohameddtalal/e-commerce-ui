...
const ProductInteraction = ({ product, selectedSize, selectedColor }: { product: ProductType; selectedSize: string; selectedColor: string }) => {
    ...
    return (
        <div className="flex flex-col gap-4 mt-4">
            ...
            <button className="ring-1 ring-gray-400 shadow-lg text-gray-800 px-4 py-2 rouned-md flex items-center justify-center gap-2 cursor-pointer text-sm font-medium">
