...
export const shippingFormSchema = z.object({
    ...
    phone: z.string().min(8, "phone number must be between 8 and 11 digits!").max(11, "phone number must be between 8 and 11 digits!").regex(/^\d+$/, "phone number must contain only numbers !"),
